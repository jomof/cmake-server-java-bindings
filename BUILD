...
java_library(
    ...
    srcs = [
        ...
        "com/jomofisher/cmakeserver/CodeModelReplyMessage.java",
        "com/jomofisher/cmakeserver/ComputeReplyMessage.java",
        "com/jomofisher/cmakeserver/Configuration.java",
        ...
        "com/jomofisher/cmakeserver/Project.java",
        "com/jomofisher/cmakeserver/ProtocolVersion.java",
        "com/jomofisher/cmakeserver/Target.java",
